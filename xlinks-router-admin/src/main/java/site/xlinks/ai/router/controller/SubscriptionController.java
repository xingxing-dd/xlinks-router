...
public class SubscriptionController {
    ...
    @PostMapping
    @Operation(summary = "Grant subscription manually")
    public Result<SubscriptionRecordVO> create(@Valid @RequestBody SubscriptionGrantDTO dto) {
        String operator = AdminAccountContext.requireAccount().getUsername();
        return Result.success(subscriptionService.createByAdmin(dto, operator));
    }
}
