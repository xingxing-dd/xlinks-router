...
export const listWallets = (params) => request('/api/wallets', { query: params })
export const batchOpenWallets = () => request('/api/wallets/batch-open', { method: 'POST' })
export const getWalletDetail = (accountId) => request(`/api/wallets/${accountId}`)
export const getWalletMainFlows = (accountId, params) => request(`/api/wallets/${accountId}/main-flows`, { query: params })
export const getWalletSubFlows = (accountId, params) => request(`/api/wallets/${accountId}/sub-flows`, { query: params })
export const walletManualCredit = (accountId, body) => request(`/api/wallets/${accountId}/manual-credit`, { method: 'POST', body })
export const walletManualDebit = (accountId, body) => request(`/api/wallets/${accountId}/manual-debit`, { method: 'POST', body })
export const walletFreeze = (accountId, body) => request(`/api/wallets/${accountId}/freeze`, { method: 'POST', body })
export const walletUnfreeze = (accountId, body) => request(`/api/wallets/${accountId}/unfreeze`, { method: 'POST', body })
export const walletPendingSettlement = (accountId, body) => request(`/api/wallets/${accountId}/pending-settlement`, { method: 'POST', body })
export const walletSettle = (accountId, body) => request(`/api/wallets/${accountId}/settle`, { method: 'POST', body })
export const walletUpdateState = (accountId, body) => request(`/api/wallets/${accountId}/state`, { method: 'PATCH', body })
export const approveWithdrawOrder = (orderNo, body) => request(`/api/wallets/withdraw-orders/${orderNo}/approve`, { method: 'POST', body })
export const rejectWithdrawOrder = (orderNo, body) => request(`/api/wallets/withdraw-orders/${orderNo}/reject`, { method: 'POST', body })
